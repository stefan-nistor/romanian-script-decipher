...
async def receive_path():
    manuscript_uploading = ManuscriptUploading(name= "BCUTimișoara689841.jpg",path= "D:\\_ user ecaaa\\Documents\\GitHub\\romanian-script-decipher\\AI-module\\manuscripts_examples\\BCUTimișoara689841.jpg", collection_id= __COLLECTION_ID__)
